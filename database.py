...
conn=mysql.connector.connect(host="localhost",user="root",password="prachkamatroot")
cursor=conn.cursor()
...
def create_table(table_name):
    ...
    values = ''
    insert_query = f"insert into {table_name} (id,name,manufacturer, price, quantity, description, certifications, image1, link) values {values};"
